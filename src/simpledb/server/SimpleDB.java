...
public class SimpleDB {
    ...
    /**
     * Drop a database. *
     * First the file manager is closed, to prevent open files blocking
     * the deletion of the data files. Then all files in the database directory
     * is deleted and finally the directory is removed. *
     */
